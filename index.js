...
class AntiSpamClient extends EventEmitter {
	...
	constructor (options) {
		...
		this.options = {
			...
			unMuteTime: options.unMuteTime * 60000 || 300000,
			...
			warnMessage: options.warnMessage || '{@user}, :x: Spamming Is Prohibited | Action(s) Taken: \n> Warn\n',
			muteMessage: options.muteMessage || '**{user_tag}** :x: Spamming Is Prohibited | Action(s) Taken: \n> Mute\n',
			kickMessage: options.kickMessage || '**{user_tag}** :x: Spamming Is Prohibited | Action(s) Taken: \n> Kick\n',
			banMessage: options.banMessage || '**{user_tag}** :x: Spamming Is Prohibited | Action(s) Taken: \n> Ban\n',
	...
	log (msg, action, client) {
        ...
        // https://discord-anti-spam.js.org/img/antispam.png
				if(this.options.modLogsMode == "embed"){
					...
					.setAuthor(`Zero Development Spam Detection`,'https://cdn.discordapp.com/icons/947259089124212817/1c51711b7ecdc0a4cf72f03acd9e9ea0.png?size=4096')
					.setDescription(`${msg.author} *(${msg.author.id})* has been **${action}** for **spam**!`)
					.setFooter(`Zero Development`,'https://cdn.discordapp.com/icons/947259089124212817/1c51711b7ecdc0a4cf72f03acd9e9ea0.png?size=4096')
					.setTimestamp()
					.setColor('RED')
